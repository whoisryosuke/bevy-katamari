...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_system(setup_physics.in_schedule(OnEnter(AppState::Game)))
        // Update
        .add_system(game_system.in_set(OnUpdate(AppState::Game)))
        .add_system(notification_ui.in_set(OnUpdate(AppState::Game)))
        .add_system(camera_follow.in_set(OnUpdate(AppState::Game)))
        .add_system(move_player.in_set(OnUpdate(AppState::Game)))
        .add_system(attach_event.in_set(OnUpdate(AppState::Game)))
        .add_system(handle_notification_events.in_set(OnUpdate(AppState::Game)))
        .add_system(notification_manager.in_set(OnUpdate(AppState::Game)))
        .add_system(input_throttle.in_set(OnUpdate(AppState::Game)))
        // CoreSet
        .add_system(display_events.in_set(OnUpdate(AppState::Game)))
        // Cleanup
...
pub fn input_throttle(mut input_throttle: ResMut<InputThrottle>, time: Res<Time>) {
